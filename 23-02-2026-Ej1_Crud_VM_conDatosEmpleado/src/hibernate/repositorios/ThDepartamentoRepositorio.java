...
public class ThDepartamentoRepositorio extends BaseDatos implements ICrud<Byte, ThDepartamento>
{
	...
	{
		//Podríamos usar try/catch o propagar el error hacia arriba. Dejaremos que falle 
	...
	public boolean eliminarEntidad(ThDepartamento entidad) 
	{
		...
		return eliminar(entidad.getDeptNo()); //Garantizamos que el parámetro entidad esté acoplado
	} 
